...
- The tutorial was originally written for a workshop at Osaka City University, June 2018, and thus refers to OCU's REDCap instance and example databases stored there.
...
stored in the `fixeddata/` directory. The script `dataclean_partial.R` in this repository reads in these files and runs our data cleaning code thus far on
these three updated datasets, resulting in the file `querydata/updated_issues.csv`.
...
saved the result of the above in the file `querydata/doc_df.csv`; read it in using:
